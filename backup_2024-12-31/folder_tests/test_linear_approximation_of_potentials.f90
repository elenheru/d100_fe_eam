subroutine test_linear_approximation_of_potentials
    ...
    real(8), parameter :: argshift = 1d-6
    integer(8) :: i
    real(8) :: argument, maxargument = 0d0
    real(8) :: function_value_an
    real(8) :: function_value_la
    real(8) :: maxvalue
    real(8) :: relative_error = 0d0, maxrelative_error = 0d0, averelative_error = 0d0
    real(8) :: absolute_error = 0d0, maxabsolute_error = 0d0, aveabsolute_error = 0d0
    real(8) :: pw_ack4pot, ed_ack4pot, mf_ack4pot
    real(8) :: d1pw_ack4pot, d1ed_ack4pot, d1mf_ack4pot
    real(8) :: pw_ack4pot_la, ed_ack4pot_la, mf_ack4pot_la
    real(8) :: d1pw_ack4pot_la, d1ed_ack4pot_la, d1mf_ack4pot_la
