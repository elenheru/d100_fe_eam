subroutine test_wo_values_la
    ...
    real(8), parameter :: argshift = 1d-1
    integer(8) :: i
    real(8) :: argument, maxargument = 0d0
    real(8) :: function_value_an
    real(8) :: function_value_la
    real(8) :: relative_error, maxrelative_error = 0d0, averelative_error = 0d0
    real(8) :: absolute_error, maxabsolute_error = 0d0, aveabsolute_error = 0d0
