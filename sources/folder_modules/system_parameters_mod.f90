module system_parameters_mod
    ...
    real(float_byte_size), parameter :: h_main_cell = 5d0 ! system is a pair of cylinders with height
    real(float_byte_size), parameter :: dh_casing_zone = 7.5d0 ! h_main_cell + dh_casing_zone
